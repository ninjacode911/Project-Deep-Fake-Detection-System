...
try:
    ...
    print("Warning: ML libraries not found. UI-only mode.")
    torch = None
    cv2 = None
...
index_template_name = 'index_modern.html'
predict_template_name = 'predict_modern.html'
